...
export const About = () => {
  ...
  <div className="grid md:grid-cols-3 gap-5 md:px-0 px-2 md:pt-8 pt-4 pb-20">
    <div className="bg-gray-800 p-5 rounded-lg shadow-lg">
      ...
      <p className="text-lg">
        At Amrita Job-Portal, we're more than just a job application platform –
        ...
        seasoned professional seeking new horizons, Amrita Job-Portal is here to
    ...
    <div className="bg-gray-800 p-5 rounded-lg shadow-lg">
      <p className="text-2xl text-yellow-500">Join the Amrita Job-Portal Community</p>
      <p className="pt-3">
        {" "}When you join Amrita Job-Portal, you're not just signing up for a platform –
      ...
      <p className="pt-4">
        Thank you for choosing Amrita Job-Portal as your partner in career
